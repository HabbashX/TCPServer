...
public class VersionChecker {
     ...
     *
     * @param serverFoundation An instance of the ServerFoundation class that provides logger functionality.
     */
    public static void checkProjectVersion(ServerFoundation serverFoundation) {
            ...
            if (connection.getResponseCode() == 200) {
                ...
                try (final var currentVersionReader = new BufferedReader(new FileReader("src/main/java/com/habbashx/tcpserver/version/version.txt"));
                    ...
                    if (currentVersion.contentEquals(newestVersion)) {
                        ...
                        serverFoundation.getServerLogger().warning("project is running on old version " + currentVersion + " update it to the new version " + newestVersion);
                    }
                }
            }
